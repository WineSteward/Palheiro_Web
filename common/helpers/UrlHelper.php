...
class UrlHelper
{
    ...
    public static function getCompanyImageUrl($imageName)
    {
        ...
        /**
     * Generate image URL for the categories folder.
     * 
     * @param string $imageName The name of the image.
     * @return string The complete image URL.
     */
    public static function getCategoriesImageUrl($imageName)
    {
        return \Yii::$app->getRequest()->getHostInfo() . Url::to('@categoriesImages') . '?imageName=' . urlencode($imageName);
    }
